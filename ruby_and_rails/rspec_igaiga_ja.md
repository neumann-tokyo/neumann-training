...
- この作業はやらなくても問題はないのですが、やるとbin/rspecコマンドが作成され、起動にspringが使われて速くなります
    - springはRails7.0でデフォルトからは外れる予定です
...
- 以下のようなエラーが出るときはChromeDriverを手動インストールしてみてください
  ...
  - またはhomebrewをつかっても/usr/local/bin/chromedriverとしてインストールできます
...
- `save_screenshot('ss.png')`
    - tmp/capybara/ss.png にスクショが撮れます
...
- パーフェクトRuby on Rails 増補改訂版 : https://gihyo.jp/book/2020/978-4-297-11462-6
    - ActionMailerとかRailsの各種機能の説明とテストコードもあわせて載ってます
    - minitestをつかっています
...
- Yuki Iwasakiさん 「Railsのシステムテスト解剖学」
    ...
    - CapybaraやSystem Testの中でやっていることを詳細に解説
